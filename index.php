	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Farm<span>MYSORE</span></p>
			</div>
			<div>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
			                        ...
			                        <label class="btn btn-secondary active">
			                            <input type="radio" id="farmer" name="category" autocomplete="off"> 
			                            <label for="farmer">Farmer</lable></label>
			                       </div>
			                      <div class="btn-group btn-group-toggle" data-toggle="buttons">
			                         <label class="btn btn-secondary ">
			                            <input type="radio" id="buyer" name="category" autocomplete="off"> 
			                            <label for="buyer">Buyer</label></label>
			                        </div>
